...
<div class="wrap netgo-admin-page-setting">
  ...
  <table class="wp-list-table widefat fixed striped pages">
   <tr>
	...
	<td colspan="2">
	<div align="right">
	 <form method="post" action="<?php echo get_option('home');?>/wp-admin/admin.php?page=title-stats" id="posts-filter">  
  ...
  <table class="wp-list-table widefat fixed striped pages"> 
	...
	<thead>
	<tr>
	   <td width="50%"><strong><a class="class-to-<?php echo $classorder; ?>" href="<?php echo get_option('home');?>/wp-admin/admin.php?page=keyword-stats&orderby=meta_value&order=<?php echo $ancorder; ?>"> SEO Title</a></strong></td>
	...
	?>
	<tr>
	   <td width="50%"><?php echo $kword= get_post_meta( get_the_ID(), '_yoast_wpseo_title', true ); ?></td>
	   <td width="30%"><?php the_title(); ?></td>
	   <?php  $post_cnt= stsysa_get_post_count( $kword);
...
<?php 
//pagination 
if (function_exists("stsysa_pagination")) {
?>
	<tr>
	   <td colspan="4">
	    <div  style="float:right;"><?php stsysa_pagination($the_query->max_num_pages); ?></div>
	   </td> 
	</tr>
<?php
} 
